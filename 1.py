...
def gen():
    ...
    while i < times:
        i += 1
        x = ['赵', '钱', '孙', '李', '周', '吴', '郑', '王', '冯', '陈', '褚', '卫', '蒋', '沈', '韩', '杨', '朱', '秦', '尤', '许', '何', '吕', '施', '张', '孔', '曹', '严', '华', '金', '魏', '陶', '姜', '戚', '谢',
             '邹', '喻', '柏', '水', '窦', '章', '云', '苏', '潘', '葛', '奚', '范', '彭', '郎', '鲁', '韦', '昌', '马', '苗', '凤', '花', '方', '俞', '任', '袁', '柳', '酆', '鲍', '史', '唐', '费', '廉', '岑', '薛', '雷']
        ming_male_list = ['伟', '勇', '军', '磊', '涛', '斌', '强', '鹏', '杰', '峰', '超', '波', '辉', '刚', '健', '明', '亮', '俊', '飞', '凯', '浩', '华', '平', '鑫', '毅', '林', '洋', '宇',
                          '敏', '建', '兵', '旭', '雷', '锋', '彬', '龙', '翔', '阳', '剑', '东', '博', '威', '海', '巍', '晨', '炜', '帅', '岩', '江', '松', '文', '云', '力', '成', '琦', '进', '昊', '宏', '欣', '坤']
        ming_female_list = ['静', '敏', '燕', '艳', '丽', '娟', '莉', '芳', '萍', '玲', '娜', '丹', '洁', '红', '颖', '琳', '霞', '婷', '慧', '莹', '晶', '华', '倩', '英', '佳', '梅', '雪', '蕾', '琴', '璐', '云', '蓉', '青', '薇',
                            '欣', '琼', '宁', '平', '媛', '虹', '杰', '婧', '雯', '茜', '楠', '洋', '君', '辉', '菲', '琦', '妍', '瑜', '蕊', '宇', '明', '珊', '琪', '玉', '怡', '文', '岚', '婕', '凤', '芬', '芸', '晓', '萌', '露', '菁', '惠', '蓓', '璇']
        ...
        ming = random.choice(
            [ming_male_1, ming_female_2, ming_male_2, ming_female_1])
